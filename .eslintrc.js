...
module.exports = {
  ...
  rules: {
    ...
    "multiline-comment-style": "error", // custom
    ...
    "strict": "off",
    "switch-colon-spacing": "error", // custom
    "symbol-description": "off",
    "template-curly-spacing": "error", // custom
    "template-tag-spacing": "off",
    "unicode-bom": "off",
    "use-isnan": "error",
    "valid-jsdoc": ["error", {requireReturn: false, prefer: {returns: 'return'}, requireParamDescription: false, requireReturnDescription: false}], // custom
    "valid-typeof": "error",
    "vars-on-top": "off",
    "wrap-iife": "off",
    "wrap-regex": "off",
